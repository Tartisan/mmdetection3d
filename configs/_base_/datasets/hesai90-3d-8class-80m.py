...
db_sampler = dict(
    ...
    rate=1.0,
    prepare=dict(
        filter_by_min_points=dict(Car=5, Bus=5, NonMot=5, Cyclist=5, 
                                  Pedestrian=5, TrafficCone=5, Barrier=5, 
                                  Others=5)),
    classes=class_names,
    sample_groups=dict(Car=30, Bus=10, NonMot=10, Cyclist=10, Pedestrian=15, 
                       TrafficCone=30, Barrier=3, Others=6),
    points_loader=dict(
