_base_ = [
    '../_base_/datasets/hesai90-3d-6class-80m.py',
    '../_base_/models/centerpoint_02pillar_second_secfpn_aicv-6class-voxel0.2-80m.py',
...
class_names = [
    'Car', 'Cyclist', 'Pedestrian', 'TrafficCone', 'NonMot', 'Others'
]
...
db_sampler = dict(
    ...
    prepare=dict(
        ...
        filter_by_min_points=dict(Car=5, Cyclist=5, Pedestrian=5, 
                                  TrafficCone=5, NonMot=5, Others=5)),
    classes=class_names,
    sample_groups=dict(Car=35, Cyclist=15, Pedestrian=15, 
                       TrafficCone=35, NonMot=15, Others=15), 
    points_loader=dict(
