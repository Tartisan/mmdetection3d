...
from mmdet3d.core import BevFeatureGenerator
...
@PIPELINES.register_module()
class BevMapFeature(object):
    """BevMapFeature

    Generating artificially designed bev feature.
    ...
    def __init__(self,
        ...
        self.bev_feature_generator = BevFeatureGenerator(
    ...
    def __call__(self, results):
        ...
        bev_map_feature = self.bev_feature_generator.generate(points)
        results['bev_map_feature'] = bev_map_feature
